...
var n = {
  ...
  yewu: {
    ...
    createCommentUrl: config.base_circle + "comment/", //创建评论
    ...
    isJoinCircle: config.base_circle + "is_join/", //判断是否加入圈子
...
module.exports = {
  ...
  //创建评论
  createComment: async (param) => {
    const token = wx.getStorageSync("Token") //获取Token 
    return await requestPromisify({
      url: n.yewu.createCommentUrl,
      method: "POST",
      data: { ...param
      },
      header: {
  ...
  //  * 有人对圈子感兴趣
  //  */
  // interCircle:async (param)=>{
  //   return await requestPromisify({
  //     url: n.yewu.interCircleUrl,
  //     method:"POST",
  //     data:{...param},
  //     header:{
  //       Accept: "application/json"
  ...
  //  * 添加圈子用户
  //  */
  // createCircle:async(param)=>{
  //   return await requestPromisify({
  //     url: n.yewu.createCircleUrl,
  //     method:"POST",
  //     data:{...param}  ,
  //     header: {
  //       Accept: "application/json"
